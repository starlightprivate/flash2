...
app.get('/.well-known/acme-challenge/acme-challenge/-lLtNbylv0-zaRWCYetAZGFJhh5uRq2jsHxCJdQJZRs', (req, res) => {
  res.send('-lLtNbylv0-zaRWCYetAZGFJhh5uRq2jsHxCJdQJZRs.6lafGIstSVHGsz_Ibk3Dbu2wVz9Z4UTLebVC09Xk1CM');
});
